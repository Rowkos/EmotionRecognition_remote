...
struct Scenarios
{
    static func getScenario(file: String, index: Int) -> String{
        ...
        do {
            ...
            let range = subString.index(subString.startIndex, offsetBy: 2)..<subString.index(subString.endIndex, offsetBy: -2)
            ...
            returnString = String(finalSplitString).replacingOccurrences(of: "..", with: ".").replacingOccurrences(of: "  ", with: " ").replacingOccurrences(of: "\"\"", with: "\"").replacingOccurrences(of: " \"", with: " ")
    ...
    static func getExplanation(file: String, index: Int) -> String{
        ...
        do {
            ...
            returnString = splitString.replacingOccurrences(of: ". .", with: ".").replacingOccurrences(of: "  ", with: " ").replacingOccurrences(of: "..", with: ".").replacingOccurrences(of: "\"\"", with: "\"").replacingOccurrences(of: "\" ", with: " ")
